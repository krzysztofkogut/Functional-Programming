...
#define CURRENT_COMPONENT_ID "hs-empty-project-plain-0.1.0.0-KteVdRdTFUvKsIlUbfXJQG"

#define CURRENT_PACKAGE_KEY "hs-empty-project-plain-0.1.0.0-KteVdRdTFUvKsIlUbfXJQG"
